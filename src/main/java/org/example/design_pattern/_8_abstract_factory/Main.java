package org.example.design_pattern._8_abstract_factory;

import org.example.design_pattern._8_abstract_factory.factory.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        //Page
        Page page = factory.createPage("Blog and News", "SHIN");
        page.add(blogTray);
        page.add(newsTray);
